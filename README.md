...
## Current authority — Stage-QDR-7 harness stabilization closeout accepted
...
旧远端CI run `29588823663`与全部formal blocked run继续作为历史证据。非正式qualification run `20260718T130056Z`完整通过15/15场景、94/94阈值比较、1144项full regression、quality、artifact、secret scan与teardown，但明确不执行capacity acceptance、不形成formal verdict。当前只允许对本地新commit执行exact-SHA CI；CI green后恢复原Retry-4，B3继续禁止。
