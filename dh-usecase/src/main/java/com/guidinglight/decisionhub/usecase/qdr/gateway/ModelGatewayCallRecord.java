...
/**
 * ModelGatewayCall persistence read model。
 *
 * <p>该 record 只暴露脱敏 metadata、hash/ref 与结构化状态；不暴露 prompt 正文或 provider 原始响应。
 *
 ...
 */
public record ModelGatewayCallRecord(
