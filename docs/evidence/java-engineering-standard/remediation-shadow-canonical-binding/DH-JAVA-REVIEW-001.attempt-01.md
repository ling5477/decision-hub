# DH Shadow canonical binding P1 remediation evidence

```text
task=NQ_DH_SHADOW_CANONICAL_BINDING_P1_REMEDIATION
pass=DH_ONLY
finding=DH-JAVA-REVIEW-001
finding_state=REMEDIATED / PENDING_INDEPENDENT_REVIEW
candidate_base_head=a49ce1014a478d929e343417aebb874f6adb3d68
previous_pass_claim=INVALIDATED_BY_INDEPENDENT_REVIEW
previous_configuration_hash=2afa49bb4f514c6a898908597d6ae2faa03a0ae616f2a45330aaef549021e93a
configuration_hash_algorithm=git-canonical-v1
candidate_configuration_hash=2945a1c70faf16b3c5557682e978a31178714ec2a8ec80725cff02087052de7c
previous_baseline_head=e2cb1ff966eb611f05d3703893fab002ea6142b4
current_baseline_head=a49ce1014a478d929e343417aebb874f6adb3d68
...
The previous baseline stored a configuration hash that the final scanner configuration could not reproduce on Windows or an LF checkout, while historical attempt evidence recorded Shadow scan and determinism as PASS. Historical attempt-01/02/03 evidence is preserved unchanged. This file records the forward-only invalidation and remediation.
...
5. `docs/standards/java/dh-java-domain-overlay.md`
...
windows_normalized_report_sha256=c37e2e4178e56d96e97d2f320107fd6993c4490d10b6e957f63fda605ef7ae15 / DETERMINISTIC
...
linux_report_sha256=c37e2e4178e56d96e97d2f320107fd6993c4490d10b6e957f63fda605ef7ae15 / DETERMINISTIC
windows_linux_configuration_hash=EQUAL
windows_linux_normalized_report_hash=EQUAL

baseline_violation_count=11
baseline_previous=9
baseline_persisted=9
baseline_resolved=0
baseline_ruleset_expansion=0
baseline_upstream_sync=2
baseline_current_task=0
