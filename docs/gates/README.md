...
`docs/gates/stage-qdr-4/` 记录 Stage-QDR-4 Replay / Evaluation / Regression Baseline 的 `CLOSED / ACCEPTED / ARCHIVED` 归档入口和实际阶段文档副本，tag 仍为 `PENDING`，下一步 tag 名为 `dh-stage-qdr-4-close`。
