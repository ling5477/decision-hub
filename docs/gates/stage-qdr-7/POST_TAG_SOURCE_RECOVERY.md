# Stage-QDR-7 Post-Tag Source Recovery

## 状态

- Stage-QDR-7 原 stage tag：`dh-stage-qdr-7-close`（保持不变）
- tag target：`6acf9c332434cafb45495d58f063a0f3faeaf475`（保持不变）
- recovery type：`POST_TAG_ARCHIVE_SOURCE_COMPLETION`
- recovered source documents：`30 / 30`
