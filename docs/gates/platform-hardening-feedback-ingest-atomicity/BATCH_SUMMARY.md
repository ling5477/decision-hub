...
| Final close | Accepted | close commit `b8e1e07...`, CI `31189681961`, annotated tag verified |
| Post-tag cleanup | Complete | four current sources pruned; cleanup publication/CI follows |
