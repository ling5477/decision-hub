...
Discovery 已由 `7fb0907...` 消费，implementation 已由 `6baabe1...` 实现、通过 milestone
review、普通 fast-forward 发布并由 exact-SHA CI 验证。该结果不扩展 discovery allowlist，
也不授权完整 B4 close、V16、B5 或任何部署。
