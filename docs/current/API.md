...
```text
当前阶段: DH-STAGE-QDR-3-FINAL-CLOSE / CLOSED / ACCEPTED / NO_API_CHANGE
下一阶段: DH-STAGE-QDR-4-PLAN / READY / PLAN_ONLY / NO_API_IMPLEMENTATION
```
...
stage-qdr-4 planning: READY / PLAN_ONLY / NO_API_IMPLEMENTATION
...
stage-qdr-3 final close: CLOSED / ACCEPTED / NO_API_CHANGE
stage-qdr-4 implementation: NOT_STARTED / NO_API_CHANGE
```
