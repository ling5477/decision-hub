...
## Current closed archive

- [Feedback ingest atomicity hardening](../gates/platform-hardening-feedback-ingest-atomicity/README.md)：`CLOSED / ACCEPTED / ARCHIVED / TAGGED`，tag target `b8e1e07c4721c7e71789bc69bcb83819e9f47e40`。
...
Stage-QDR-9 B1、B2 与 B3 已发布并接受，但 Stage 尚未整体 close/archive/tag。B4 retention 仍未开始；未来 B5 才可在完成全部 batch 后复制 plan、work order 与各 batch 原始 source documents，形成 self-contained archive packet 并完成 archive commit，之后才可由独立授权任务创建 annotated tag。
