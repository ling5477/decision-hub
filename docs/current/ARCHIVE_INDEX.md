...
Stage-QDR-9 B1 已本地接受，但 Stage 尚未 close/archive/tag。未来 B5 仍必须复制 plan、work order 与各 batch 原始 source documents，形成 self-contained archive packet 并完成 archive commit 后，才可由独立授权任务创建 annotated tag。
