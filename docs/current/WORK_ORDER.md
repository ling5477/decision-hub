...
K8 status: NOT STARTED
Next: DH-GATEK-DECISION-PIPELINE-MVP-K8-ACCEPTANCE-FREEZE / NOT STARTED
```
...
K7 Golden Cases / Eval: IMPLEMENTED / READY FOR ACCEPTANCE
