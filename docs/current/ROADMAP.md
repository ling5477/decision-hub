...
当前路线：B1 schema/contracts 已本地接受，下一步仅为 B1 milestone review；review 通过后才可另起 B2 PostgreSQL/JDBC persistence。B3 internal historical read model、B4 integrity/retention 与 B5 final close 仍未开始，API 与 automatic learning 不在 Stage-QDR-9 路线内。
