...
## Terminal disposition（2026-07-19）

最后一次原Retry-4在exact HEAD与已通过的远端CI后执行一次。run `20260719T082658Z`因冻结preflight要求的`postgres:17`镜像未缓存，在15个mandatory scenario启动前以Maven exit `1`、internal exit `10`阻断。该结果没有形成容量PASS或容量FAIL证据，按终局规则映射为：
...
CAPACITY_HARNESS: CLOSED / ACCEPTED / UNCHANGED
REMOTE_CI: PASS / RUN 29679227229 / EXACT HEAD 1fb49fc1b77d874dc82a010a6bcf0a202920e52a
FINAL_FORMAL_RUN_ID: 20260719T082658Z
FINAL_FORMAL_RESULT: BLOCKED / ENVIRONMENT_CAPACITY_PREFLIGHT_BLOCKED
FINAL_FORMAL_REASON: POSTGRES IMAGE CHECK / EXPECTED CACHED postgres:17 / ACTUAL MISSING
FINAL_FORMAL_MAVEN_EXIT: 1
FINAL_FORMAL_INTERNAL_EXIT: 10
FINAL_FORMAL_CAPACITY_ACCEPTANCE_EXECUTED: false
FINAL_FORMAL_PREFLIGHT: 25 OF 26 PASS / 1 BLOCKED
FINAL_FORMAL_SCENARIOS: STARTED 0 / COMPLETED 0 / PARTIAL 0 / NOT_STARTED 15
FINAL_FORMAL_THRESHOLDS: EXECUTED 0 / NOT_EVALUATED 94
FINAL_FORMAL_REGRESSION: BLOCKED / NOT_EXECUTED
FINAL_FORMAL_QUALITY: BLOCKED / NOT_EXECUTED
FINAL_FORMAL_ARTIFACTS: PASS / 27 FILES / 26 MANIFEST ENTRIES / 0 MISMATCH
FINAL_FORMAL_SECRET_SCAN: PASS / 25 FILES / 0 FINDINGS
FINAL_FORMAL_TEARDOWN: PASS / RESIDUAL NONE
...
本终局不允许拉取镜像后重跑、不允许修改harness/criteria、不允许新B2 blocker或Retry-5。B3只开放planning；冻结work order缺少具体B3任务名，因此本任务没有自行命名。

## Historical pre-final disposition（2026-07-19）

Capacity acceptance criteria保持`FROZEN / ACCEPTED`，B2保持`CLOSED / ACCEPTED`。Surefire fork startup stabilization本地验收已通过；新提交的exact-SHA远端CI与最后一次原Retry-4 formal尚未执行，因此当前结论为：
...
HARNESS_STABILIZATION: CLOSED / ACCEPTED
SUREFIRE_FORK_STARTUP_STABILIZATION: CLOSED / ACCEPTED
FORMAL_PROFILE: qdr7-capacity-acceptance
HISTORICAL_FORMAL_RUN_IDS: 20260715T140521Z + 20260715T160710Z + 20260716T144346Z + 20260717T151351Z + 20260718T065630Z
LATEST_FORMAL_RUN_ID: 20260719T035205Z
LATEST_FORMAL_RESULT: BLOCKED / ENVIRONMENT_SUREFIRE_FORK_STARTUP_BLOCKED / MAVEN EXIT 1 / INTERNAL EXIT NOT_EMITTED
LATEST_FORMAL_CAPACITY_ACCEPTANCE_EXECUTED: false
LATEST_FORMAL_PREFLIGHT: NOT_EXECUTED / HARNESS NOT_REACHED
LATEST_FORMAL_SCENARIOS: STARTED 0 / COMPLETED 0 / PARTIAL 0 / NOT_STARTED 15
LATEST_FORMAL_ARTIFACT_ROOT: NOT_CREATED
LATEST_FORMAL_MANDATORY_ARTIFACTS: NOT_GENERATED
IMPLEMENTATION_VALIDATION_RUN_ID: 20260719T071924Z
IMPLEMENTATION_VALIDATION_RESULT: PASS / INTERNAL EXIT 0 / PREFLIGHT 26 OF 26 / 0 OF 15
QUALIFICATION_RUN_ID: 20260719T072450Z
QUALIFICATION_RESULT: PASS / NOT_FORMAL / QUALIFICATION_ONLY / MAVEN EXIT 0 / INTERNAL EXIT 0
QUALIFICATION_PREFLIGHT: PASS / 26 OF 26
QUALIFICATION_SCENARIOS: STARTED 15 / COMPLETED 15 / PASSED 15 / PARTIAL 0 / FAILED 0 / BLOCKED 0 / NOT_STARTED 0
QUALIFICATION_CORRECTNESS: PASS
QUALIFICATION_THRESHOLDS: PASS / 94 OF 94 COMPARISONS
QUALIFICATION_CLEANUP: PASS / 10 + 100 + 1000
QUALIFICATION_CONTENTION: PASS
QUALIFICATION_SAME_POOL_RECOVERY: PASS / 3 OF 3
QUALIFICATION_CONTEXT_RESTART: PASS / 3 OF 3
QUALIFICATION_PERSISTENT_VOLUME_RESTART: PASS / 3 OF 3
QUALIFICATION_POST_RECOVERY: PASS / CONCURRENCY 8 / 100 OF 100 STRUCTURED 2XX
QUALIFICATION_FULL_REGRESSION: PASS / 19 OF 19 REACTOR SUCCESS / 1145 / 0 FAILURES / 0 ERRORS / 0 SKIPPED
QUALIFICATION_QUALITY: PASS / CHECKSTYLE 0 / SPOTLESS PASS / 19 OF 19 REACTOR SUCCESS
...
QUALIFICATION_CAPACITY_ACCEPTANCE_EXECUTED: false
QUALIFICATION_FORMAL_ACCEPTANCE_VERDICT: NOT_EVALUATED
INDEPENDENT_DEFAULT_REGRESSION: PASS / 19 OF 19 / 172 REPORTS / 1145 / 0 FAILURES / 0 ERRORS / 0 SKIPPED
INDEPENDENT_QUALITY: PASS / CHECKSTYLE 0 / SPOTLESS PASS / 19 OF 19
BENIGN_DUMPSTREAM_EXCLUSION: AUTHORIZED / 310 BYTES / BOOT MANIFEST-JAR + DIFFERENT ROOT ONLY / NOT STAGED / NON-BLOCKING
HISTORICAL_REMOTE_CI: PASS / RUN 29588823663 / HEAD f2f07ad3f14875165263e66428e3fe472bbe3cef
HISTORICAL_REMOTE_CI_2: PASS / RUN 29646937611 / HEAD 20c665c7506c9f96da341944635918eec5275b7f / 1144 TESTS / QUALITY PASS
...
Qualification仍只作为`NOT_FORMAL`证据，不能替代formal。默认Surefire classloader、manifest-only JAR和全局fork模式未修改；310-byte cross-drive dumpstream只含已授权提示，不提交且不阻断。下一步严格限于exact-SHA远端test + quality CI与最后一次原Retry-4 formal，不得创建Retry-5。

最后一次formal Retry-4后固定终止B2工具修复循环：PASS写为`PASSED / ACCEPTED`；真实容量FAIL写为`FAILED / EVIDENCE_COMPLETE`并关闭B2；再次环境或harness BLOCKED写为`DEFERRED / KNOWN_LIMITATION`与`CLOSED WITH CAPACITY GATE DEFERRED`。三种终态均只允许B3 planning，禁止B3 implementation；real HTTP、real Provider、NQ runtime integration、Agent、LangGraph、Paper和LIVE继续禁止。

## Historical Retry-4 environment-preflight disposition（2026-07-17）

Capacity acceptance criteria保持`FROZEN / ACCEPTED`，B2保持`CLOSED / ACCEPTED`。远端CI run `29588823663`已在exact HEAD `f2f07ad3f14875165263e66428e3fe472bbe3cef`通过。Retry-4 formal run `20260717T151351Z`仅执行一次，但PowerShell preflight采样可用内存低于冻结baseline，15个mandatory scenarios未启动；当时验收结论为：

```text
POST_B2_CAPACITY_ACCEPTANCE: BLOCKED / ENVIRONMENT_CAPACITY_PREFLIGHT_BLOCKED
CAPACITY_ACCEPTANCE_CRITERIA: FROZEN / ACCEPTED
CAPACITY_HARNESS_WORK_ORDER: CLOSED / ACCEPTED
CAPACITY_HARNESS_IMPLEMENTATION: CLOSED / ACCEPTED
FORMAL_PROFILE: qdr7-capacity-acceptance
HISTORICAL_FORMAL_RUN_IDS: 20260715T140521Z + 20260715T160710Z + 20260716T144346Z
LATEST_FORMAL_RUN_ID: 20260717T151351Z
LATEST_FORMAL_RESULT: BLOCKED / ENVIRONMENT_CAPACITY_PREFLIGHT_BLOCKED / INTERNAL EXIT 10 / 0 OF 15
LATEST_FORMAL_REASON: AVAILABLE_MEMORY_BELOW_FROZEN_BASELINE
LATEST_FORMAL_PREFLIGHT: BLOCKED / 25 OF 26 PASS / AVAILABLE_MEMORY
LATEST_FORMAL_AVAILABLE_MEMORY_BYTES: 16762941440
LATEST_FORMAL_REQUIRED_MEMORY_BYTES: 17179869184
LATEST_FORMAL_MEMORY_DEFICIT_BYTES: 416927744
LATEST_FORMAL_MAVEN_EXIT: 1
LATEST_FORMAL_MANDATORY_SCENARIOS: BLOCKED / 0 OF 15 EXECUTED
LATEST_FORMAL_FULL_REGRESSION_SCENARIO: BLOCKED / NOT_EXECUTED
LATEST_FORMAL_QUALITY_SCENARIO: BLOCKED / NOT_EXECUTED
LATEST_FORMAL_ARTIFACTS: PASS / 26 FILES / 25 MANIFEST ENTRIES / 0 MISMATCH
LATEST_FORMAL_SECRET_SCAN: PASS / 0 FINDINGS
LATEST_FORMAL_TEARDOWN: PASS / RESIDUAL NONE
...
CROSS_PLATFORM_CI_FIX: REMOTE CI PASSED / ACCEPTED
REMOTE_CI_RUN_ID: 29588823663
REMOTE_CI_HEAD: f2f07ad3f14875165263e66428e3fe472bbe3cef
REMOTE_CI_FULL_REGRESSION: PASS / 1141 / 0 FAILURES / 0 ERRORS / 0 SKIPPED
REMOTE_CI_POSTGRESQL_MANDATORY_TESTS: PASS / ZERO SKIPS
REMOTE_CI_QUALITY: PASS / CHECKSTYLE 0 / SPOTLESS PASS / 19 OF 19 REACTOR SUCCESS
IMPLEMENTATION_VALIDATION_RUN_ID: 20260717T122621Z
...
IMPLEMENTATION_VALIDATION_SECRET_SCAN: PASS / 0 FINDINGS
IMPLEMENTATION_VALIDATION_TEARDOWN: PASS / CURRENT RUN CONTAINER AND VOLUME ABSENT
CRITERIA_SEMANTIC_DIFF: 0
CRITERIA_THRESHOLD_DIFF: 0
CRITERIA_MACHINE_READABLE_CONFIG_DIFF: 0
CRITERIA_RAW_BYTE_REINDEX: PASS / d015a48e92be91b9f6b0a5f73c358405924af15044c809e48d3034ed57973cab
B2_IMPLEMENTATION_STATUS: CLOSED / ACCEPTED
Stage-QDR-7 B3: NOT_ALLOWED
ALLOW_FORMAL_RETRY_4: NO / CONSUMED_BLOCKED
...
Retry-3的`actual-wiring.json`记录13个structured 2xx，但formal summary明确`capacityAcceptanceExecuted=false`与0/15，因此不得把partial artifact提升为capacity PASS。该次Retry-4在formal preflight即按冻结memory baseline fail-closed，26个artifact、25项manifest、secret scan与teardown完整，但没有任何formal scenario measurement；完整历史结论见`DH_STAGE_QDR_7_B2_FORMAL_CAPACITY_ACCEPTANCE_RESULT.md`。当时无安全授权关闭用户IDE/浏览器进程以释放内存，因此未碰运气重跑。
...
## Historical same-pool recovery disposition（2026-07-14）
