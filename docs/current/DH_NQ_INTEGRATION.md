...
注：上一段中的“允许进入 close review”是 blocker fix 当轮 readiness 记录，已由本轮 `NQ-DH-I1-JOINT-RUNTIME-DRYRUN-TEST-CLOSE-REVIEW / PASS / CLOSED / ACCEPTED` 消费；当前 next 只能是 `NQ-DH-I1-INTEGRATION1-MOCK-RUNTIME-CLOSE-REVIEW`。
