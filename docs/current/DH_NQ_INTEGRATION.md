...
Integration-1 dry-run 后续 P4 最多只能做：
...
以下数据流只保留为历史背景，不代表当前系统已经开始集成，也不是当前 implementation。当前唯一下一步是 `NQ-DH-I1-P4-IMPLEMENTATION-GATE-REVIEW / NOT STARTED`，且仍为 gate review，不是 runtime implementation。
