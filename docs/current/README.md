...
执行口径：
  ...
  - stage-qdr-3 planning DONE / PLAN_ONLY；implementation NOT STARTED / NOT ALLOWED。
  - 下一步必须先写 stage-qdr-3 implementation work order，不得直接实现。
