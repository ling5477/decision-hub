...
## 当前 identity / replay namespace 设计

- [Identity and replay namespace design](DH_STAGE_QDR_9_B4_IDENTITY_AND_REPLAY_NAMESPACE_DESIGN.md)
- [Identity and replay namespace work order](DH_STAGE_QDR_9_B4_IDENTITY_AND_REPLAY_NAMESPACE_WORK_ORDER.md)
- [Identity and replay namespace scope erratum](DH_STAGE_QDR_9_B4_IDENTITY_AND_REPLAY_NAMESPACE_SCOPE_ERRATUM.md)

## 当前 AUDIT environment structured storage 设计

- [Audit environment storage design](DH_STAGE_QDR_9_B4_AUDIT_ENVIRONMENT_STORAGE_DESIGN.md)
- [Audit environment forward-migration work order](DH_STAGE_QDR_9_B4_AUDIT_ENVIRONMENT_FORWARD_MIGRATION_WORK_ORDER.md)
- [Audit environment scope erratum](DH_STAGE_QDR_9_B4_AUDIT_ENVIRONMENT_SCOPE_ERRATUM.md)
- [Legacy persistent identity retirement design](DH_STAGE_QDR_9_B4_LEGACY_PERSISTENT_IDENTITY_DESIGN.md)
- [Legacy persistent identity retirement work order](DH_STAGE_QDR_9_B4_LEGACY_PERSISTENT_IDENTITY_WORK_ORDER.md)
- [Legacy persistent identity scope erratum](DH_STAGE_QDR_9_B4_LEGACY_PERSISTENT_IDENTITY_SCOPE_ERRATUM.md)
...
## 当前 B4 Maven module dependency scope

- [Maven module dependency scope erratum](DH_STAGE_QDR_9_B4_UPSTREAM_MODULE_DEPENDENCY_SCOPE_ERRATUM.md)
- [Upstream contract scope erratum](DH_STAGE_QDR_9_B4_UPSTREAM_CONTRACT_SCOPE_ERRATUM.md)
- [Persistent guard fixture scope erratum](DH_STAGE_QDR_9_B4_PERSISTENT_GUARD_FIXTURE_SCOPE_ERRATUM.md)
- [Upstream implementation work order](DH_STAGE_QDR_9_B4_PRODUCER_ENVIRONMENT_UPSTREAM_IMPLEMENTATION_WORK_ORDER.md)

`dh-security -> dh-domain` 已由已实现的单向依赖使用，且只导入 canonical `FeedbackEnvironment`。upstream implementation 在工作区等待验证；唯一 scope blocker 是 legacy persistent guard PostgreSQL fixture。它现已获 one-file 兼容性范围授权，effective upstream scope 为 `48 / 48 PASS`；fixture technical fix 与完整回归仍待执行。
...
- [Trusted upstream authority decision](DH_STAGE_QDR_9_B4_PRODUCER_ENVIRONMENT_UPSTREAM_AUTHORITY_DECISION.md)
- [Upstream implementation work order](DH_STAGE_QDR_9_B4_PRODUCER_ENVIRONMENT_UPSTREAM_IMPLEMENTATION_WORK_ORDER.md)
- [Upstream contract scope erratum](DH_STAGE_QDR_9_B4_UPSTREAM_CONTRACT_SCOPE_ERRATUM.md)

AUDIT 仅冻结为 Option B（新的显式 signed tenant/source/environment contract required）；原 42-file scope 已在 implementation preflight 中阻断，scope erratum 将 corrected effective scope 冻结为 `46 / 46 PASS`，但上游合同仍 `BLOCKED BEFORE CODE WRITE`。REPLAY 与 EVALUATION 保持 DORMANT / NO PRODUCTION ENTRY。V16、registry、retention、API、scheduler 与 automatic learning 均未获授权。
...
当前 source-blocker 权威文档：

- `DH_STAGE_QDR_9_B4_PRODUCER_ENVIRONMENT_SOURCE_RESOLUTION.md`
- `DH_STAGE_QDR_9_B4_PRODUCER_ENVIRONMENT_SOURCE_IMPLEMENTATION_WORK_ORDER.md`
