...
AUDIT 仅冻结为 Option B（新的显式 signed tenant/source/environment contract required）；REPLAY 与 EVALUATION 保持 DORMANT / NO PRODUCTION ENTRY。V16、registry、retention、API、scheduler 与 automatic learning 均未获授权。
