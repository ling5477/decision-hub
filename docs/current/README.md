...
B1 已完成 scope erratum 与 milestone review，并 `CLOSED / ACCEPTED LOCALLY`。下一任务仅为两个本地 B1 commits 的 publication 与 exact-SHA CI；JDBC Repository、historical read model、retention、API 与 automatic learning 均未开始。
