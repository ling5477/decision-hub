...
B1、B2 与 B3 均已发布并接受；B4 retention implementation 存在但 milestone review 因 reference-liveness state model 未解析而阻断。统一 registry 设计已冻结，V16 仅为候选且尚未创建；B4 publication、milestone review retry 与 B5 均不允许。
