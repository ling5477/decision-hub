...
Agent / LangGraph: NO
LIVE: DISABLED
CURRENT_TASK: DH-STAGE-QDR-6-ARCHIVE-TAG-CLOSE
CURRENT_TASK_STATUS: ARCHIVE_PACKET_READY / TAG_PENDING
NEXT_TASK: annotated tag close for dh-stage-qdr-6-close
MODE: DOCS_ONLY + ARCHIVE_BEFORE_TAG + NO_STAGE_QDR_7_PLAN
```
