...
## Current authority — 2026-07-12 schema errata decision

```text
STAGE_QDR_7_B1: FROZEN
STAGE_QDR_7_B2: BLOCKED / SCHEMA_ERRATA_REVIEWED
STAGE_QDR_7_B2_SCHEMA_ERRATA_REVIEW: PASS
SELECTED_REMEDIATION: beforeEachMigrate TRANSACTIONAL_CALLBACK
...
下一任务只允许callback事件迁移、安全加固和对应PostgreSQL tests/current docs；禁止修改V1–V14、API、外部合同、容量默认值或runtime边界。
