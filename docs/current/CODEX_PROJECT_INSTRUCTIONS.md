...
B3 implementation 只可由冻结任务 ID 启动，并必须遵守 `DH_STAGE_QDR_7_B3_PLAN.md` 与 `DH_STAGE_QDR_7_B3_IMPLEMENTATION_WORK_ORDER.md`。不得重新打开 B2、重跑 formal、创建 Retry-5，也不得扩展 API、migration、Repository、真实 HTTP、Provider、NQ、Agent、LangGraph、Paper 或 LIVE。
