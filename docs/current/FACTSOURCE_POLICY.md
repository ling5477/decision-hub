...
12 个 terminal factsources 仍由下文固定集合组成；`DH_STAGE_QDR_9_PLAN.md` 是当前 Stage 规划 authority 与入口，但不增加 terminal block 扫描基数。长期 machine contract 不得依赖该可裁剪 process document。
