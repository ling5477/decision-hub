...
/**
 * Int0Contract 冻结 DH-NQ Integration-0 contract test 的常量口径。
 *
 * <p>来源：{@code docs/current/DH_NQ_INTEGRATION0_CONTRACT_FREEZE.md} /
 * {@code DH_NQ_INTEGRATION0_SECURITY_POLICY.md} / {@code DH_NQ_INTEGRATION0_CONTRACT_TEST_PLAN.md}。
 *
 * <p>本类仅用于测试。Integration-0 不是真实集成：这里不连接任何真实 NQ、真实 DH client（RealClient）、
 * 真实 Provider、真实交易所或真实凭证；所有 secret / tenant / source 都是固定假值。
 */
public final class Int0Contract {
  ...
  public static final List<String> FORBIDDEN_FIELDS =
      List.of(
          "apiKey",
          "apiSecret",
          "secret",
  ...
  public static final List<String> FORBIDDEN_CAPABILITIES =
      List.of(
          "placeOrder",
          "cancelOrder",
          "mutateOrderStatus",
  ...
  /** Integration-0 contract test 用的反馈事件枚举（test-only，不耦合 main code）。 */
  public static final List<String> ALLOWED_FEEDBACK_EVENT_TYPES =
      List.of(
          "PAPER_RUN_CREATED",
  ...
  public static final List<String> CANDIDATE_REQUIRED_FIELDS =
      List.of(
          "contractName",
          "version",
          "direction",
  ...
  public static final List<String> FEEDBACK_REQUIRED_FIELDS =
      List.of(
          "contractName",
          "version",
          "direction",
