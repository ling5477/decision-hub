 ...
 *
 * <p>只保存可追踪字段，禁止保存 secret / 签名原材料 / raw payload / prompt / context。 本类不写真实审计日志、不写数据库；仅在测试中断言 audit event
 * shape。
 */
public record Int0AuditEvent(
  ...
  public static Int0AuditEvent received(
      String source, String tenantId, String requestId, String traceId) {
