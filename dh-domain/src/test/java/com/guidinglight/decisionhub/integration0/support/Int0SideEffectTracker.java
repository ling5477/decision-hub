 ...
 *
 * <p>它模拟一个“交易副作用网关 / RealClient”：如果 contract validation 误触发任何下单 / 撤单 / Paper 启停 / 策略·风控状态变更 / adapter / exchange
 * / LIVE / 真实 NQ 调用，计数会增加。Integration-0 contract validation 必须永不调用这些方法，因此测试断言 {@link #total()} 恒为 0。
 *
 * <p>本类不连接任何真实交易网关、adapter、交易所或真实 NQ。
 */
